...
import ListCard from './DropComponentsThird';


class DropComponentsSecond extends Component {
    ...
    _renderRowsComponents(renderData) {
        return (
            <ListCard name={renderData.name} person={renderData.person} />
        )
    }
...
module.exports = DropComponentsSecond;